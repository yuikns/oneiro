   ...
   <?php } ?>
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <div class="post-meta">
                ...
                <span class="con-time">
                <?php if(function_exists('the_views')) { the_views(); } ?>　<?php the_time('Y.m.j'); ?>
                </span	
			></div><!--.postMeta-->
			...
			<div class="post-content">
            	...
            	<?php if ( has_post_thumbnail() ) {
				 echo '<div class="thumbg"><div class="featured-thumbnail">'; the_post_thumbnail( array(150,150) );; echo '</div></div>'; 
				 } else { } ?> <!-- Thumbnail judgment code -->
