      ...
      <div class="list">
       ...
       <div class="master"> 
         ...
         <div class="master-layout" >
        		 ...
        		 <?php if (function_exists('get_avatar')) { ?><div class="gravatar2"><?php echo get_avatar( $comment, 32 ); ?></div><?php } ?>
                 
				<cite><?php comment_author_link() ?></cite> 
                      
          		 <span  class="masterinfo"><?php to_reply(); ?><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date() ?> <?php comment_time('H:i'); ?></a>
          ...
          </div>  <span style="color:#F60; padding-left:5px;">
                        <?php if ($comment->comment_approved == '0') : ?>
                       Your comment is awaiting moderation.<?php endif; ?></span>
        </div> <!--.master end-->
       ...
       <div class="customer"> 
         ...
         <div class="customer-layout" >
        		 ...
        		 <?php if (function_exists('get_avatar')) { ?><div class="gravatar"><?php echo get_avatar( $comment, 32 ); ?></div><?php } ?>
                 
				<cite><?php comment_author_link() ?></cite> 
                      
          		 <span  class="customerinfo"><?php to_reply(); ?><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date() ?> <?php comment_time('H:i'); ?></a>
