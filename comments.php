...
<?php // don't delete , to judge if is encrypted
if (isset($_SERVER['SCRIPT_FILENAME']) && 'comments.php' == basename($_SERVER['SCRIPT_FILENAME'])) {
    die('Please do not load this page directly. Thanks!');
}
if (post_password_required()) {
    ?>
    <h3 id="respond"><?php _e('This post is password protected. Enter the password to view comments.');
    ?></h3>
<?php return;
} ?>
<!-- Start of Comments -->
<?php if (have_comments()): ?>
        ...
        <!--Comments styles, specific functions also written in functions.php-->
...
<div id="author_info">
        ...
        <label for="author" ><span class="authoricon"><?php _e('Name'); ?> <?php if ($req) {
    _e('(Required)');
} ?></span></label>
    <div class="form_row">
        ...
        <label for="email" ><span class="emailicon"><?php _e('Email');?> <?php if ($req) {
    _e('(Required)');
} ?></span></label>
    <div class="form_row">
...
<div class="input">
<p><textarea name="comment" id="comment" cols="100%" rows="10" tabindex="4" onkeydown="if((event.ctrlKey || event.metaKey)&&event.keyCode==13){document.getElementById('submit').click();return false};"></textarea></p>
