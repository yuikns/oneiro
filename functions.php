...
add_shortcode('mp3','mp3link');
	...
	function Options_add_theme_page(){add_theme_page(__(themename.'说明'), __(themename.'说明'), 'edit_themes', basename(__FILE__), 'Options_theme_page');}
       ...
       <div class="customer"> 
         ...
         <div class="customer-layout" >
				...
				<cite><?php comment_author_link() ?></cite> 
          		 ...
          		 <span  class="customerinfo"><?php to_reply(); ?><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date() ?> <?php comment_time('H:i:s'); ?></a>
