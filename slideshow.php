<?php wp_reset_query(); if (is_home()) {
	...
	<script  src="<?php bloginfo('template_url');
     ?>/js/loopedSlider.js">// 加载幻灯片插件</script>
	<script> // 幻灯片的参数设置
...
<div id="slidebar">
	<div class="slidebg">
     ...
     ?>/example/example1.jpg" alt="例子1，只有图片"  />
                  </div>

                  	<!--开始第二个幻灯片-->
                  <div>
                    <a href="#"><img src="<?php bloginfo('template_url');
     ?>/example/example2.jpg" alt="例子2，含有链接的图片" /></a>
                  </div>

                  	<!--开始第三个幻灯片-->
                  <div>
                    <img src="<?php bloginfo('template_url');
     ?>/example/example3.jpg" alt="例子3，图片+介绍文字" />
                  ...
                  <div>
                     <a href="#"> <img src="<?php bloginfo('template_url');
     ?>/example/example4.jpg" alt="例子4，链接图片+介绍文字" /></a>
					   <span class="slidestext">
							  <h3> 『EVA:破』 画面曝光</h3>
